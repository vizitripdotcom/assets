$(document).ready(function () {
    ...
    const spinner = $('<div class="spinner-border spinner-border-sm text-primary ms-2 d-none" role="status" id="diskon-spinner"><span class="visually-hidden">Loading...</span></div>');
